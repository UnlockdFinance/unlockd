...
export const getReservesConfigByPool = (pool: UnlockdPools): iMultiPoolsAssets<IReserveParams> =>
...
export const getNftsConfigByPool = (pool: UnlockdPools): iMultiPoolsNfts<INftParams> =>
