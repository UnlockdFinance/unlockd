...
contract MockNFTOracle is Initializable, OwnableUpgradeable {
  ...
  function setNFTPrice(address _collection, uint256 _tokenId, uint256 _price) external onlyPriceManager {
  ...
  function getNFTPrice(
    address _collection,
    uint256 _tokenId
  ) external view onlyExistingCollection(_collection) returns (uint256) {
  ...
  function setPause(address _collection, bool paused) external onlyOwner onlyExistingCollection(_collection) {
