...
task("dev:deploy-incentives-controller", "Deploy address provider for dev enviroment")
  ...
  .setAction(async ({ verify, pool }, localBRE) => {
    ...
    console.log("Incentives controller address: ", incentivesController.address);
  });
