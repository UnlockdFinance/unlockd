...
import { getDebtMarketProxy, getLendPool, getLendPoolAddressesProvider } from "../../helpers/contracts-getters";
import { insertContractAddressInDb } from "../../helpers/contracts-helpers";
import { waitForTx } from "../../helpers/misc-utils";
import { eContractid, eNetwork } from "../../helpers/types";

task("upgrade:deploy-debt-market", "Deploy the debt market contract")
