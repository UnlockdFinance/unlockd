...
task("provider:getLendPool", "User gets the LendPool address").setAction(async () => {
  const wallet = await getOwnerWallet();
...
task("provider:getLendPoolConfigurator", "User gets the LendPoolConfigurator address").setAction(async () => {
  const wallet = await getOwnerWallet();
...
task("provider:getLtvManager", "User gets the Loan to Value Manager Address").setAction(async () => {
  const wallet = await getOwnerWallet();
...
task("provider:getLendPoolLiquidator", "User gets the lendPoolLiquidator Address").setAction(async () => {
  const wallet = await getOwnerWallet();
...
task("provider:setLendPoolLiquidator", "User sets a new LendPoolLiquidator address")
...
task("provider:getPoolAdmin", "User gets the lendpool admin Address").setAction(async () => {
  const wallet = await getOwnerWallet();
...
task("provider:getEmergencyAdmin", "User gets the lendpool emergency admin Address").setAction(async () => {
  const wallet = await getOwnerWallet();
...
task("provider:setEmergencyAdmin", "User sets a lendpool emergency admin address")
...
task("provider:getReserveOracle", "User gets the address of the reserve oracle").setAction(async () => {
  const wallet = await getOwnerWallet();
...
task("provider:getNFTOracle", "User gets the address of the NFT oracle").setAction(async () => {
  const wallet = await getOwnerWallet();
...
task("provider:getLendPoolLoan", "User gets the LendPoolLoan address").setAction(async () => {
  const wallet = await getOwnerWallet();
...
task("provider:getUNFTRegistry", "User gets the address of the UNFT registry").setAction(async () => {
  const wallet = await getOwnerWallet();
...
task("provider:getIncentivesController", "User gets the address of the incentives controller").setAction(async () => {
  const wallet = await getOwnerWallet();
...
task("provider:setIncentivesController", "User sets the address of the incentives controller")
...
task("provider:getUIDataProvider", "User gets the address of the UI Data Provider").setAction(async () => {
  const wallet = await getOwnerWallet();
...
task("provider:setUIDataProvider", "User sets the address of the UI Data Provider")
...
task("provider:getUnlockdDataProvider", "User gets the address of the Unlockd Data Provider").setAction(async () => {
  const wallet = await getOwnerWallet();
...
task("provider:getWalletBalanceProvider", "User gets the address of the Wallet Balance Provider").setAction(
  async () => {
    const wallet = await getOwnerWallet();
...
task("provider:setWalletBalanceProvider", "User sets the address of the Wallet Balance Provider")
